...
class Element(object):
    ...
    '''
    # name=''
    # q = 0       # Расход через элемент, л/с
    # s = 0       # Гидравлическое сопротивление
    # H_in = 0    # Напор на входе, м
    # h = 0       # Потеря напора, м
    # z = 0       # Перепад высот, м
    # p = 1       # Пропускная способность оборудования
    # n = 1       # Количество элементов (нужно в основном для рукавных линий, где это количество рукавов в рукавной линии)
    # H_add = 0   # Напор генерируемый элементом
    # self.observer     #Объект наблюдателя за эоементом
